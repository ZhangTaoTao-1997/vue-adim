  ...
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 类别信息管理</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      <el-table
        ...
        <el-table-column prop="jieshao" label="介绍" width="800">
        </el-table-column>
...
//      },
      ...
      deleteRow(row) {
        ...
        data.push(row.id);
        that.$axios({
          url: 'http://127.0.0.1:9202/catelog/delete',
          method: "post",
          data: data
        }).then(res => {
          if (res.data == 1) {
