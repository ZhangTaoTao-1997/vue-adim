  ...
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 客户信息查看</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      <el-table
        ...
        <el-table-column prop="mingcheng" label="客户名" width="150">
        </el-table-column>
...
//          dizhi:that.form.dizhi,
        ...
        that.$axios({
          url: 'http://127.0.0.1:9202/kehu/updateKehu',
          method: "post",
          data: data
        }).then(res => {
          if (res.data == 1) {
      ...
      deleteRow(row) {
        ...
        data.push(row.id);
        that.$axios({
          url: 'http://127.0.0.1:9202/kehu/delete',
          method: "post",
          data: data
        }).then(res => {
          if (res.data == 1) {
      ...
      addEdit(){
        ...
        that.$axios({
          url: 'http://127.0.0.1:9202/kehu/addKehu',
          method: 'post',
          data: data
        }).then(res => {
          if (res.data == 1) {
