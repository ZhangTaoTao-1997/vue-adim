    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 音乐信息</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="music.slice((currentPage-1)*pagesize,currentPage*pagesize)"
                      stripe
...
//        },
        methods: {
            getMusic(){
                ...
                that.$axios({
                    type: "get",
                    url:'http://127.0.0.1:9202/manage/getAllMusic',
                    dataType: 'json',
                }).then(res=>{
                    that.music=res.data
                }).catch()
            ...
            deleteRow() {
                ...
                that.$axios({
                    url: 'http://127.0.0.1:9202/manage/deleteMusic',
                    method: "post",
                    data: data
                }).then(res => {
                    if (res.data == 1) {
