  ...
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 药品流水明细</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      <el-table
        ...
        <el-table-column prop="goodsId" label="货品名称" width="300">
        </el-table-column>
        <el-table-column prop="shuliang" label="数量" width="300">
        </el-table-column>
        <el-table-column prop="beizhu" label="备注" width="300">
        </el-table-column>
    ...
    <el-dialog title="新增" :visible.sync="addVisible" width="30%">
      <el-form ref="form1" :model="form1" label-width="50px">
        ...
        <el-form-item label="介绍">
          <el-input v-model="form1.jieshao"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
//      },
      ...
      info() {
        this.$axios({
          type: "get",
          url:'http://127.0.0.1:9202/chukumingxi/findall',
          dataType: 'json',
        }).then(res=>{
          this.Tuser=res.data
          //这些数据视情况，是你从后端拿来的。
      ...
      saveEdit(row) {
        ...
        that.$axios({
          url: 'http://127.0.0.1:9202/catelog/updateCatelog',
          method: "post",
          data: data
        }).then(res => {
          if (res.data == 1) {
      ...
      deleteRow(row) {
        ...
        data.push(row.id);
        that.$axios({
          url: 'http://127.0.0.1:9202/chukumingxi/delete',
          method: "post",
          data: data
        }).then(res => {
          if (res.data == 1) {
      ...
      addEdit(){
        ...
        let data = {
          ...
          jieshao: this.form1.jieshao,
        };
        that.$axios({
          url: 'http://127.0.0.1:9202/catelog/addCatelog',
          method: 'post',
          data: data
        }).then(res => {
          if (res.data == 1) {
